...
const CONFIG = {
    ...
    questions: {
        ...
        third: {
            text: "Will you be my Valentine on this February 14th? 🌹", // The big question!
            yesBtn: "Yes!",                                             // Text for "Yes" button
            noBtn: "No ( it better not be this) "                       // Text for "No" button
        }
    },
    ...
    loveMessages: {
        extreme: "🥺🥺🥺🥺 cutieee (i love you more tho) ",  // Shows when they go past 5000%
        high: "awwwww rlly?",              // Shows when they go past 1000%
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dznq9w0dh/video/upload/v1770449479/BIRDS_OF_A_FEATHER_-_Billie_Eilish_z56z3a.mp3", // Music streaming URL
